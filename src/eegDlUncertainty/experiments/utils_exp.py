...
def get_parameters_from_config(config_path):
    ...
    num_fc_layers = config.get("model", {}).get("num_fc_layers")
    neurons_fc = config.get("model", {}).get("neurons_fc")
    use_batch_fc = config.get("model", {}).get("use_batch_fc")
    use_dropout_fc = config.get("model", {}).get("use_dropout_fc")
    dropout_rate_fc = config.get("model", {}).get("dropout_rate_fc")
